                ...
                return (
                  <Fragment key={id}>
                    ...
                    >
                      <div className='flex gap-2'>
                        <Avatar>
                          {profile && <AvatarImage src={profile} alt={username} />}
                          <AvatarFallback>{fullName.split(' ').map((n) => n[0]).join('').toUpperCase().slice(0, 2)}</AvatarFallback>
                        </Avatar>
                        <div>
                ...
                <div className='flex gap-3'>
                  ...
                  <div className='flex items-center gap-2 lg:gap-4'>
                    <Avatar className='size-9 lg:size-11'>
                      {selectedUser.profile && <AvatarImage
                        src={selectedUser.profile}
                        alt={selectedUser.username}
                      />}
                      <AvatarFallback>{selectedUser.fullName.split(' ').map((n) => n[0]).join('').toUpperCase().slice(0, 2)}</AvatarFallback>
                    </Avatar>
                    <div>
